  ...
  return (
    <>
      ...
      <div className="bg-maincolor-150  mx-44 p-8  text-lg rounded-xl text-white px-28  sm:text-sm sm:mx-10 sm:p-8   ">
        <p>
          Greetings! As a web developer, I am passionate about turning creative
          ...
          computer science and a strong interest in web development, and I am
          excited to work on creative projects. Right now, I am up for
          interesting collaborations and new opportunities. Together, lets
